...
# Please move to vtst scripts, if you want to use it. change name to pei_vasp_univ_neb_nebbarrier.pl
...
### revised by J. Pei
# 添加标题行
#printf NEB "%3s %16s %16s %16s %8s\n", "#ID", "Cumulative_Dist(Å)", "Relative_Energy(eV)", "Force(eV/Å)", "Image";
### revision closed
