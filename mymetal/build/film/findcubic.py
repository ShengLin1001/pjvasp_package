...
This submodule provides functions for finding the cubic cell of a thin film
structure.

Functions:
    - find_cubic: Finds the xy plane cubic cell of the primitive atoms (hcp/fcc film).
    - find_optimal_cell_shape: Obtains the optimal transformation matrix for a supercell of target size and shape.
    - get_deviation_from_optimal_cell_shape: Calculates the deviation from the target cell shape.
"""
