...
from mymetal.build.findhetero import (find_hetero, my_plot_results, my_find_hetero, set_length, magnitude, build_supercells, stack_atoms, scale_cell_xy)
...
__all__ = ['my_find_prim', 'move_atoms', 'check_direction',
           'add_hydro_atoms',
            ...
            'find_hetero', 'my_plot_results', 'my_find_hetero', 'set_length', 'magnitude', 'build_supercells', 'stack_atoms', 'scale_cell_xy',
