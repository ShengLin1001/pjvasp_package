...
from mymetal.build.film.stretch import (generate_film, stretch_list_along_direction_to_cell, generate_bulk_from_film)
...
__all__ = ['my_find_prim', 'move_atoms', 'check_direction',
           'add_hydro_atoms', 'get_neighbors', 'find_matching_atom_in_bulk', 'find_unsaturated_neighbors', 'passivate_surface_custom',
            'generate_film', 'stretch_list_along_direction_to_cell', 'generate_bulk_from_film',
